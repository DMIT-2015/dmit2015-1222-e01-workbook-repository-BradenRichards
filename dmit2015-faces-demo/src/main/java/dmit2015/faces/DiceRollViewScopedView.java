...
public class DiceRollViewScopedView implements Serializable {
    ...
    private String[] _diceFaceValueImages = {
        "resources/img/dice/dice-shield.png", //This dice is only here to set the index# at 1
    ...
    public void onRollDice(){
        ...
        diceFaceValue = rand.nextInt(1,7); //1-7 for six sided die because 7 is not inclusive
        //Use the face value of the dice to determine the image to display
